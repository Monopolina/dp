  ...
  <div class="container">
    ...
    <div class="subcategory__item-container">			
      <a class="subcategory__item ui-link ui-link" href="/OcnComplpc">					<div class="subcategory__content">
        ...
        <input type="checkbox" id="Основные комплектующие для ПК" class="subcategory__mobile-checkbox">
        <label class="subcategory__mobile-title " for="Основные комплектующие для ПК">Основные комплектующие для ПК</label>
      ...
      <a class="subcategory__item ui-link ui-link_blue" href="/YctrRasshi">					<div class="subcategory__content">
        ...
        <input type="checkbox" id="Устройства расширения" class="subcategory__mobile-checkbox">
        <label class="subcategory__mobile-title" for="Устройства расширения">Устройства расширения</label>
        <div class="subcategory__childs"></div>
        </a>
      ...
      <input type="checkbox" id="Моддинг и обслуживание" class="subcategory__mobile-checkbox">
      <label class="subcategory__mobile-title" for="Моддинг и обслуживание">Моддинг и обслуживание</label>
      <div class="subcategory__childs"></div>
      </a>
      ...
      <input type="checkbox" id="Комплектующие для сервера" class="subcategory__mobile-checkbox">
      <label class="subcategory__mobile-title" for="Комплектующие для сервера">Комплектующие для сервера</label>
      <div class="subcategory__childs"></div>
      </a>
    </div>
